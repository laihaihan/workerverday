...
<div id="form_content">
	<div id="form_toolbar">
		...
		<button class="form_btn" id="btnGuiDang"><img src="${path}/core/themes/default/images/admin/default_btn.gif"> 结束归档 </button>
	...
	<div>
		...
		<input type="hidden" name="shenpishijian" id="shenpishijian" value="<%=DateTime.getNowDateTime()%>">
 		<table width="98%" align="center" class="form_table">
 			<tr>
			  <th  colspan="4"  style="weith:100%" align="center"> 审批意见</th>
 			</tr>
			<tr>
 			  <td colspan="4">
 			    <textarea rows="5" cols="135"  name='worklog[]shenpiyijian' id='shenpiyijian' >${worklog.shenpiyijian}</textarea>
			  </td>
			</tr>
