	...
	var requestConfig = {
		...
		callback : function(options, success, response) {
			if (success) {
				...
				if (!exResult)
					return;
				window.location = ucapSession.appPath + "APPADMIN/login.jsp?loginOut=true";
...
/**
 * 进入平台的系统管理模块（只有平台管理员才有此功能）
 */
var goToAppManager = function(){
	window.location = ucapSession.appPath + "APPADMIN/index.jsp";
};
/**
 * 进入门户设计器
 */
  ...
  <body>
	...
	<div id="headerBox" class="topBox ">
		...
		<div class="toolBar">
	    	...
	    	<ul>
             <li><img src="style/images/systemManage/welcome.png"/><a>当前用户：<%=user.getDisplayName() %></a></li>
     		 <li><img src="style/images/systemManage/cancellation.png"/><a href="javascript:void(0);" onclick="loginOut();">注销</a></li>
             <li><img src="style/images/systemManage/designer.png"/><a href="javascript:void(0);" onclick="goToPortal();">门户设计器</a></li>
             
             <!-- 
		    	mdy by wyongjian@linewell.com 2012-08-21
                IE6下使用“a href="javascript:void(0); "”后，“window.location”将失效，改为“a href="### "”
		     -->        
	     	 <li><img src="style/images/systemManage/systems.png"/><a href="###" onclick="goToAppManager();">旧版系统管理</a></li>
    		</ul>
			<div class="toolBarLeft"></div>	
		    <!-- end mdy by wyongjian@linewell.com 2012-08-21-->
		</div>
	</div>
	<!--页眉 end-->
	<div>
			...
			<div id="ucapSystemButtonListBox" class="ucapSystemButtonListBox">
				<ul>
				    ...
				    <li btnType="08" onmouseover="this.className='ucapSystemButtonListSelect'" onmouseout="this.className=''">
						<a href="javascript:void(0);">
						<img src="style/images/systemManage/codeGeneration.png" align="absmiddle" />代码生成</a></li>
					<!-- 
					<li btnType="08" onmouseover="this.className='ucapSystemButtonListSelect'" onmouseout="this.className=''">
						<a href="javascript:void(0);">
