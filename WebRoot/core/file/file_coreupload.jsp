...
<div id="form_content">
	<fieldset style="width:99%">
		...
		<table width="95%" border="0" align="center" cellpadding="3" cellspacing="2" class="form_table_ext">
			<tr>
				<td>
					<input type="hidden" name="filepath" id="filepath" value="" style="width:50%" readonly>请上传附件
		       		<input id="uploadify" class="uploadify" type="file" name="file"/>
...
<script type="text/javascript">
	...
	$(function(){
		...
		'uploader'				: '${path}/core/js/uploadify/uploadify.swf',   
       		'script'         	: 'AppFile.action?belongTo=<%=unid%>',   
