...
<%
	...
	//if(null == isOk){
	   PremiereDataHelper.analysis4ReportToHandlestate(begintime,endtime,dept,jndi);
...
<body>
  ...
  <div id="flashcontent">
	...
	<script type="text/javascript">
		...
		// <![CDATA[		
		var so = new SWFObject("../../amcolumn/amcolumn.swf?num="+randrandom_number, "amcolumn", <%=w %>, <%=h %>, "8", "#000000");
		so.addVariable("path", "../../amcolumn/");
		so.addVariable("settings_file", encodeURIComponent("../spxml/amcolumn_settings_handlestate.xml?num="+randrandom_number));
		so.addVariable("data_file", encodeURIComponent("../spxml/amcolumn_data_handlestate.xml?num="+randrandom_number));
