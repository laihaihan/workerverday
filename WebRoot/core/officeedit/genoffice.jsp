...
<body  onload='intializePage("<%=fileUrl%>")' onbeforeunload ="onPageClose()">
    ...
    <input type="hidden" value="genoffice" name="fn"/>
    <input name="filename" id="filename" type="hidden" value="<%=fileName%>" />
<div id="form_content">
	<div id="form_toolbar">
		<button class="form_btn" id="btnSave" onclick="saveFileToUrl();"><img src="${path}/core/themes/default/images/admin/default_btn.gif"/> 生成文档 </button>
            ...
            <div id="editmain_right" class="editmain_right">
                ...
                <div id=statusBar style="height:20px;width:100%;background-color:#c0c0c0;font-size:12px;"></div>
								...
								<script language="JScript" for=TANGER_OCX event="OnDocumentOpened(TANGER_OCX_str,TANGER_OCX_obj);">
									...
									OFFICE_CONTROL_OBJ.ActiveDocument.AcceptAllRevisions();//除去修订
									OFFICE_CONTROL_OBJ.SetReadOnly(true);//设置只读
								</script>
