...
function showToolbar(){
  ...
  document.write ("<DIV CLASS=Btn TITLE='"+lang["Print"]+"' onclick=\"format('Print')\"><IMG CLASS=Ico SRC='buttonimage/blue/print.gif'></DIV></div></td></tr></table>");
