...
<tr>
  ...
  <input  style='width:325px' type='text' name='staff[]department' id='department_cn_' value='${staff.department}''/>
     <input type="button" name="btnselect" value="选择" onclick="top.lwin.selectWindow('200','0','department');"/>
...
<tr>
  ...
  <td>
    ...
    <input type="button" name="btnselect" value="选择" onclick="top.lwin.selectWindow('201','0','leader');"/>
...
function checkForm(){
		...
		if(!TextValidation.checkNull("contact","联系方式")){
			flag = false;
		}
		if(!TextValidation.checkEmail("email","电子邮件")){
			flag = false;
		}
		return flag;
	}
