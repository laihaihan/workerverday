				...
				<TR>
					<TD vAlign="top" height="24">
						<TABLE width="100%" align="center" cellpadding="2" cellspacing="1" border="0" bgcolor="#DCEFFF">
							<TBODY>
								<tr>
							    <td width="20%" rowspan="2" align="center" bgcolor="#DCEFFF">所属系统</td>
							    <td width="10%" align="right" bgcolor="#FFFFFF">区域名称</td>
							    ...
							    <td width="8%" align="right" bgcolor="#FFFFFF">部门名称</td>
							  ...
							  <tr>
							  <td bgcolor="#FFFFFF" align="right"> 开始时间</td>
							  <td bgcolor="#FFFFFF"> 
							  ...
							  <td bgcolor="#FFFFFF" align="right">截至时间</td>
							  ...
							  <tr>
							    <td colspan="5" bgcolor="#FFFFFF" align="center"><input style="cursor:hand" name="queryButton" type="button" class="btn_2k3" id="queryButton" value=" 查  询 " onclick="search();"/></td>
							  </tr>											  	
							</TBODY>
						</TABLE>
					</TD>
