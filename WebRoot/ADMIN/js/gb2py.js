...
/**
 * 获取拼音
 * @param {String}  str  获取拼音的汉字字符串
 * @param {boolean} only 是否只有首字母（大写）true：有
 * @param {String}  sp   分隔符
 * return 返回拼音
 */ 
function getSpell(str, only, sp){	
    var i,c,t,p,ret="";
    ...
    for(i=0;i<str.length;i++){
        ...
        }else if((charCode>96 && charCode<123)||(charCode>64 && charCode<91)){//如果是英文直接加英文字母		
			ret += str.charAt(i);
		}
    }
