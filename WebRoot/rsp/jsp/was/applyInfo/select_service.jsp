	...
	$(function(){
		...
		function doSubmit(){
			...
			if(rows.length==1){
				...
				$.ajax({
					type: "POST",
				   	url: "${path}/rsp/wasServiceAction.action",
				   	data: "fn=getSiteidByServiceid&serviceid="+unid,
				   	dataType: "json",
				   	async: false,
				   	success: function(obj){
				   		top.popup.showModalDialog('rsp/jsp/was/applyInfo/was_info_edit.jsp?serviceid='+unid+'&siteid='+obj.siteid,'站点配置','800','650');
				   	}
				});
			}else{
				alert('请选择一行');
