...
<table class="tableSet" >
  ...
  <tr>
    <th>部门编号：</th>
	  <td colspan="3"><input id="serialNumber" name="serialNumber" type="text" class="inputbox"  /></td>
  </tr>
	   <tr>
	   	<th>上级部门</th>
	    <td colspan="3" >
	    <span style="display:none;">
	     <input type="text" class="inputbox" name="belongto"  id="belongto" />
	      ...
	      <input type="text" class="inputred" name="belongto_Cn_"  />
	   </tr>
	  <tr>
	    <th>部门领导</th>
	    <td colspan="3" >
