...
public class CacheFilter implements Filter{  
    ...
    public static void main(String [] args) throws ServletException {  
        ...
        cf.init(null);  
        System.out.println(cf.matchPattern("/egov/core/js/lw-ui/winCookie.js"));  
        System.out.println(cf.matchPattern("http://localhost:90/egov/js/ucap/flow/jquery-1.5.min.js"));  
        System.out.println(cf.matchPattern("http://localhost:90/egov/js/ucap/select/listSelect.js"));  
        System.out.println(cf.matchPattern("http://localhost:90/egov/uistyle/style_1/css/ucap.css"));  
    }  
}  
