...
<% 
	...
	String condition = "type=? and belongto=? and expiry_date>=?";
	String[] params = new String[]{type,userunid,DateTime.getNowDateTime("yyyy-MM-dd")};
	List list = new ShareLibAttrManager().doFindListByCondition(condition,params);
