 ...
 * $Id: jquery.media.js,v 1.1 2013/04/09 08:51:26 zjianhui Exp $
 *
...
var appPath = "/" + location.pathname.split("/")[(location.pathname.indexOf("/")>0?0:1)] + "/";//应用路径
$.fn.media.defaults = {
	...
	flvPlayer:	 appPath + '/core/js/media/player/FlvPlayer.swf',
